...
class ERFA(FunctionApproximator):
    ...
    def faLearnLastApproximation(self, input, output, target):
        ...
        self.finalfa.faLearnLastApproximation(self.representation, output,
                                              target)
...
class SelectableOutputEfficientERFA(SelectableOutput, EfficientERFA):
    ...
    def faLearnLastApproximation1(self, representation, scalarout, scalartarget,
                                  outputnumber):
