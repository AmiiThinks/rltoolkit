...
class ObjectGridworldView(ObjectGridworld, GridworldView):
    ...
    def handleSquareClick(self, agent,
                          square):  # click can add barrier or object, not just barrier
...
class ObjectGridworldWindow(GridworldWindow):
    ...
    def writeFile(self, filename):
        ...
        olist['objects'] = strlist(
            self.gridview.objects)  # str(self.gridview.objects)
