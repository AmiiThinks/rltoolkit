...
class Gview(CSinfo,
            tkinter.Canvas):  # <a name="Gview"></a>[<a href="g.html#Gview">Doc</a>]
    ...
    def gGetChildren(
            self):  # <a name="gGetChildren"</a>[<a href="g.html#gGetChildren">Doc</a>]
    ...
    def gSetParent(self, newparent):
        ...
        if parent != None and parent != newparent and not isinstance(newparent,
                                                                     tkinter.Toplevel):
    ...
    def gDrawView(
            self):  # <a name="gDrawView"</a>[<a href="g.html#gDrawView">Doc</a>]
    ...
    def gCursor(self,
                cursorname):  # <a name="gCursor"</a>[<a href="g.html#gCursor">Doc</a>]
...
class Gwindow(Gview):
    ...
    def __init__(self,
                 **kwargs):  # <a name="Gwindow...)"</a>[<a href="g.html#Gwindow...)">Doc</a>]
        "Initialization for Gwindow"
        global GDEVICE
        new = tkinter.Toplevel(
            GDEVICE)  # make a Toplevel window, and put a canvas(Gview) under it
        self.screenx = 25  # default placement for Toplevel window on screen device
        self.screeny = 65
        self.menu = None
        GDEVICE.childwindows.append(
            self)  # keep track of this guy in main device
        ...
        self.place(in_=self.parent, anchor=tkinter.NW, relheight=1, relwidth=1,
                   relx=0, rely=0)
        gUpdateNormalization(self)
    ...
    def setViewSize(self, h, v=None, changegeom=True):
        ...
        if changegeom:  # window needs to be resized, not just new values saved
            ...
            geom = str(self.wwidth) + 'x' + str(self.wheight) + '+' + str(
                self.screenx) + '+' + str(self.screeny)
    ...
    def gCloseView(
            self):  # <a name="gCloseView"</a>[<a href="g.html#gCloseView">Doc</a>]
        "Close the window"
        self.gDestroy(None)
...
class Gdevice(CSinfo,
              tkinter.Tk):  # <a name="Gdevice"</a>[<a href="g.html#Gdevice">Doc</a>]
    """Object for a device, such as a screen or printer"""

    def __init__(self):
        "Initialization for Gdevice"
        tkinter.Tk.__init__(self)
        CSinfo.__init__(self, self.winfo_screenwidth(),
...
def gdGetViewport(
        view):  # <a name="gdGetViewport"</a>[<a href="g.html#gdGetViewport">Doc</a>]
...
def gGetViewport(
        view):  # <a name="gGetViewport"</a>[<a href="g.html#gGetViewport">Doc</a>]
...
def gdGetViewportR(
        view):  # <a name="gdGetViewportR"</a>[<a href="g.html#gdGetViewportR">Doc</a>]
...
def gGetViewportR(
        view):  # <a name="gGetViewportR"</a>[<a href="g.html#gGetViewportR">Doc</a>]
...
def gdSetViewport(view, dx1, dy1, dx2,
                  dy2):  # <a name="gdSetViewport"</a>[<a href="g.html#gdSetViewport">Doc</a>]
...
def gSetViewport(view, vpx1, vpy1, vpx2,
                 vpy2):  # <a name="gSetViewport"</a>[<a href="g.html#gSetViewport">Doc</a>]
...
def gGetCoordinateSystem(
        view):  # <a name="gGetCoordinateSystem"</a>[<a href="g.html#gGetCoordinateSystem">Doc</a>]
...
def gSetCoordinateSystem(view, x1, y1, x2, y2, corner='lowerLeft'):
    ...
    if x1 == x2:
        print(
            "Attempt to Set left and right of g Coordinate System to same values.")
        x2 = x1 + 1
    elif y1 == y2:
        print(
            "Attempt to Set top and bottom of g Coordinate System to same values.")
        y2 = y1 + 1
    else:
...
def gdCoordx(view,
             x):  # <a name="gdCoordx"</a>[<a href="g.html#gdCoordx">Doc</a>]
    return int(round(view.offsetx + (x * view.scalex)))


def gdCoordy(view,
             y):  # <a name="gdCoordy"</a>[<a href="g.html#gdCoordy">Doc</a>]
...
def gCoordx(view,
            dx):  # <a name="gCoordx"</a>[<a href="g.html#gCoordx">Doc</a>]
    return float(dx - view.offsetx) / view.scalex


def gCoordy(view,
            dy):  # <a name="gCoordy"</a>[<a href="g.html#gCoordy">Doc</a>]
...
def gOffsetx(view,
             dxoffset):  # <a name="gOffsetx"</a>[<a href="g.html#gOffsetx">Doc</a>]
    return float(dxoffset) / view.scalex


def gOffsety(view,
             dyoffset):  # <a name="gOffsety"</a>[<a href="g.html#gOffsety">Doc</a>]
...
def gColorPen(view, color='black', pattern=None, mode=None, xsize=None,
              ysize=None):
...
def gColorRGB(view, red, green,
              blue):  # <a name="gColorRGB"</a>[<a href="g.html#gColorRGB">Doc</a>]
...
def gColorRGB255(view, red, green,
                 blue):  # <a name="gColorRGB255"</a>[<a href="g.html#gColorRGB255">Doc</a>]
    "Returns a color - red, green and blue go from 0 to 255"
    red = int(min(255, max(0,
                           red)))  # bound the values between 0 and 255, make sure integer
...
def gColorUserPick(view,
                   **args):  # <a name="gColorUserPick"</a>[<a href="g.html#gColorUserPick">Doc</a>]
...
def gSetColor(view,
              color):  # <a name="gSetColor"</a>[<a href="g.html#gSetColor">Doc</a>]
...
def gdDrawPoint(view, dx, dy,
                colorcode=None):  # <a name="gdDrawPoint"</a>[<a href="g.html#gdDrawPoint">Doc</a>]
    ...
    return view.create_oval(dx, dy, dx + xsize, dy + ysize, width=0,
...
def gdOutlineRectR(view, dx, dy, deltax, deltay, colorcode=None):
    ...
    color, pattern, mode, (xsize, ysize) = getColor(view, colorcode)
    return view.create_rectangle(dx, dy, deltax + 1, deltay + 1, outline=color,
                                 width=xsize)
...
def gdFillRectR(view, dx, dy, deltax, deltay, colorcode=None):
    ...
    deltax, deltay = canvasPoint(view, deltax, deltay)
    color, pattern, mode, (xsize, ysize) = getColor(view, colorcode)
    return view.create_rectangle(dx, dy, deltax + 1, deltay + 1, fill=color,
                                 outline=color, stipple=pattern)
...
def gdDrawCircle(view, dx, dy, dradius, colorcode=None):
    ...
    dx, dy = canvasPoint(view, dx, dy)
    color, pattern, mode, (xsize, ysize) = getColor(view, colorcode)
    return view.create_oval(dx - dradius, dy - dradius, dx + dradius,
                            dy + dradius, outline=color, width=xsize)
...
def gdDrawArc(view, dx, dy, dradius, startangle, angle, colorcode=None):
    ...
    dx, dy = canvasPoint(view, dx, dy)
    color, pattern, mode, (xsize, ysize) = getColor(view, colorcode)
    return view.create_arc(dx - dradius, dy - dradius, dx + dradius,
                           dy + dradius, start=startangle, extent=angle, \
...
def gdTextWidth(Viewignore, string,
                characterstyle):  # <a name="gdTextWidth"</a>[<a href="g.html#gdTextWidth">Doc</a>]
...
def gMakeVisible(
        view):  # <a name="gMakeVisible"</a>[<a href="g.html#gMakeVisible">Doc</a>]
...
def gDrawPoint(view, x, y,
               colorcode=None):  # <a name="gDrawPoint"</a>[<a href="g.html#gDrawPoint">Doc</a>]
    dx = gdCoordx(view, x)
    dy = gdCoordy(view, y)
    return gdDrawPoint(view, dx, dy, colorcode)


def gDrawLine(view, x1, y1, x2, y2,
              colorcode=None):  # <a name="gDrawline"</a>[<a href="g.html#gDrawline">Doc</a>]
...
def gOutlineRect(view, x1, y1, x2, y2,
                 colorcode=None):  # <a name="gOutlineRect"</a>[<a href="g.html#gOutlineRect">Doc</a>]
    dx1 = gdCoordx(view, x1)
    dy1 = gdCoordy(view, y1)
    dx2 = gdCoordx(view, x2)
    dy2 = gdCoordy(view, y2)
...
def gFillRect(view, x1, y1, x2, y2,
              colorcode=None):  # <a name="gFillRect"</a>[<a href="g.html#gFillRect">Doc</a>]
    dx1 = gdCoordx(view, x1)
    dy1 = gdCoordy(view, y1)
    dx2 = gdCoordx(view, x2)
    dy2 = gdCoordy(view, y2)
...
def gDrawCircle(view, x, y, radius,
                colorcode=None):  # <a name="gDrawCircle"</a>[<a href="g.html#gDrawCircle">Doc</a>]
    dx = gdCoordx(view, x)
    dy = gdCoordy(view, y)
...
def gDrawDisk(view, x, y, radius,
              colorcode=None):  # <a name="gDrawDisk"</a>[<a href="g.html#gDrawDisk">Doc</a>]
    dx = gdCoordx(view, x)
    dy = gdCoordy(view, y)
    dradius = gdOffsetx(view, radius)
...
def gFillPolygon(view, colorcode=None,
                 *pts):  # <a name="gFillPolygon"</a>[<a href="g.html#gFillPolygon">Doc</a>]
    newpts = []
...
def gDrawText(view, string, font, x, y,
              colorcode=None):  # <a name="gDrawText"</a>[<a href="g.html#gDrawText">Doc</a>]
    dx = gdCoordx(view, x)
    dy = gdCoordy(view, y)
...
def gTextHeight(view, text,
                characterstyle):  # <a name="gTextHeight"</a>[<a href="g.html#gTextHeight">Doc</a>]
...
def gdDrawArrowR(view, dx, dy, deltax, deltay, colorcode=None):
    ...
    return gdDrawArrowhead(view, dx, dy, dx + deltax, dy + deltay, 1.0, 0.25,
                           colorcode)
...
def gdDrawArrowhead(view, dx1, dy1, dx2, dy2, bodySize, headSize,
                    colorcode=None):
...
def gdDrawArrowheadR(view, dx, dy, deltax, deltay, bodySize, headSize,
                     colorcode=None):
    "Draws an arrowhead starting at dx,dy and ending at dx+deltax,dy+deltay of color and sizes"
    gdDrawArrowhead(view, dx, dy, dx + deltax, dy + deltay, bodySize, headSize,
                    colorcode)


def gDrawArrow(view, x1, y1, x2, y2,
               colorcode=None):  # <a name="gDrawArrow"</a>[<a href="g.html#gDrawArrow">Doc</a>]
    dx1 = gdCoordx(view, x1)
    dy1 = gdCoordy(view, y1)
    dx2 = gdCoordx(view, x2)
    dy2 = gdCoordy(view, y2)
...
def gDrawArrowhead(view, x1, y1, x2, y2, bodySize, headSize, colorcode=None):
    ...
    dx2 = gdCoordx(view, x2)
    dy2 = gdCoordy(view, y2)
    return gdDrawArrowhead(view, dx1, dy1, dx2, dy2, bodySize, headSize,
                           colorcode)

    # <a name="gDrawArrowheadR"</a>[<a href="g.html#gDrawArrowheadR">Doc</a>]


def gDrawArrowheadR(view, x, y, deltax, deltay, bodySize, headSize,
                    colorcode=None):
    return gDrawArrowhead(view, x, y, x + deltax, y + deltay, bodySize,
                          headSize, colorcode)
...
def gDelete(view,
            object):  # <a name="gDelete"</a>[<a href="g.html#gDelete">Doc</a>]
...
def gSetTitle(windoworbutton,
              newtitle):  # <a name="gSetTitle"</a>[<a href="g.html#gSetTitle">Doc</a>]
...
def gSetCursor(view,
               cursorname='arrow'):  # <a name="gSetCursor"</a>[<a href="g.html#gSetCursor">Doc</a>]
...
def gAddButton(view, btext, bcommand, xpos, ypos,
               background=None):  # <a name="gAddButton"</a>[<a href="g.html#gAddButton">Doc</a>]
    """Adds a button to view with text btext, command bcommand, 
        at position xpos, ypos, background of view is background
        e.g. gAddButton(w, "run", runcommand, 100, 100, 'blue')"""
    return gdAddButton(view, btext, bcommand, gdCoordx(view, xpos),
                       gdCoordy(view, ypos), background)


def gButtonEnable(
        button):  # <a name="gButtonEnable"</a>[<a href="g.html#gButtonEnable">Doc</a>]
    "Enables a button and makes it visible and active"
    button.config(state=tkinter.NORMAL)


def gButtonDisable(
        button):  # <a name="gButtonDisable"</a>[<a href="g.html#gButtonDisable">Doc</a>]
...
def gAddMenu(parent, menuname,
             menuitems=None):  # <a name="gAddMenu"</a>[<a href="g.html#gAddMenu">Doc</a>]
    ...
    if not isinstance(parent, (Gwindow, tkinter.Menu)) and not parent == GMENU:
        ...
        for i in menuitems:
            if i == 'separator' or i == '---':
                ...
                bcom, l, v, on, off, c = i
                m.add_checkbutton(label=l, variable=v, onvalue=on, offvalue=off,
                                  command=c)
            else:
...
GMENU = tkinter.Menu(
    GDEVICE)  # Application wide menu that all windows will inherit
GDEVICE["menu"] = GMENU
